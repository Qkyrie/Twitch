...
if [ "$TRAVIS_BRANCH" = 'master' ] && [ "$TRAVIS_PULL_REQUEST" == 'false' ]; then
    ...
    openssl aes-256-cbc -K $encrypted_2c7748f57258_key -iv $encrypted_2c7748f57258_iv -in scripts/continuous-integration/codesigning.asc.enc -out scripts/continuous-integration/codesigning.asc -d
